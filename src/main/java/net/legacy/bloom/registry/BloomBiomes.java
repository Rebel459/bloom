...
import net.legacy.bloom.worldgen.biome.AridBeach;
...
public class BloomBiomes {
    ...
    public static final ResourceKey<Biome> ARID_BEACH = AridBeach.INSTANCE.getKey();
    ...
    public static void bootstrap(BootstrapContext<Biome> context) {
        ...
        register(context, ARID_BEACH, TropicalRiver.INSTANCE.create(context));
        register(context, TROPICAL_RIVER, TropicalRiver.INSTANCE.create(context));
        register(context, TROPICAL_BEACH, TropicalRiver.INSTANCE.create(context));
    }
