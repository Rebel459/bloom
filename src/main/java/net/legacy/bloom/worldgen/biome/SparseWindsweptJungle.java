...
public final class SparseWindsweptJungle extends FrozenBiome {
    ...
    public static final SparseWindsweptJungle INSTANCE = new SparseWindsweptJungle();
    ...
    public String biomeID() {
        return "sparse_windswept_jungle";
    }
    ...
    public void addFeatures(BiomeGenerationSettings.Builder features) {
        ...
        BiomeDefaultFeatures.addSparseJungleMelons(features);
    }
