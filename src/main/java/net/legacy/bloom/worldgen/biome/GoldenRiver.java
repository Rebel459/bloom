...
public final class GoldenRiver extends FrozenBiome {
    ...
    public static final GoldenRiver INSTANCE = new GoldenRiver();
    ...
    public void fillEnvironmentAttributes(EnvironmentAttributeMap.Builder builder) {
        ...
        builder.set(EnvironmentAttributes.BACKGROUND_MUSIC, BiomeHelper.music(BloomSounds.MUSIC_BIOME_GOLDEN_FOREST, true));
    }
