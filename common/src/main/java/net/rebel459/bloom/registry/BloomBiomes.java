...
import net.rebel459.bloom.worldgen.biome.AridShore;
import net.rebel459.bloom.worldgen.biome.ColdBeach;
import net.rebel459.bloom.worldgen.biome.ColdRiver;
import net.rebel459.bloom.worldgen.biome.Fen;
...
import net.rebel459.bloom.worldgen.biome.SnowyPineTaiga;
import net.rebel459.bloom.worldgen.biome.SnowyShore;
import net.rebel459.bloom.worldgen.biome.SparseWindsweptJungle;
import net.rebel459.bloom.worldgen.biome.TropicalBeach;
import net.rebel459.bloom.worldgen.biome.TropicalRiver;
import net.rebel459.bloom.worldgen.biome.WarmRiver;
import net.rebel459.bloom.worldgen.biome.WindsweptJungle;
