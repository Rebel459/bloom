...
public class BloomBiomeTags {
	...
	public static final TagKey<Biome> IS_MOUNTAIN = bindCommon("is_mountain");
	public static final TagKey<Biome> IS_CAVE = bindCommon("is_cave");

	private static TagKey<Biome> bind(String path) {
        return TagKey.create(Registries.BIOME, Bloom.id(path));
    }

	private static TagKey<Biome> bindCommon(String path) {
